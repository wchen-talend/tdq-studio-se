...
public class IndicatorSelectDialog3 extends TrayDialog implements IIndicatorSelectDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        style |= SWT.BORDER;
        style |= SWT.SINGLE;
        gridPrview = new ColumnPreviewGrid(this, comp, style, modelElementIndicators);
        gridIndicator = new IndicatorSelectGrid(this, comp, style, modelElementIndicators);
        ...
        indicatorGridData.minimumHeight = 570;
        ...
        previewGridData.minimumHeight = gridPrview.getItemHeight() * 10;
