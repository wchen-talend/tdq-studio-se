 ...
 */
public class IndicatorSelectGrid extends AbstractIndicatorSelectGrid implements Observerable {

    List<TalendObserver> Observers = null;
     ...
     * .TalendObserver)
     */
    public boolean addObserver(TalendObserver observer) {
        initObserverable();
     ...
     * .TalendObserver)
     */
    public boolean removeObserver(TalendObserver observer) {
        if (Observers == null) {
            return false;
        }
    ...
    public void notifyObservers() {
        ...
        for (TalendObserver observer : Observers) {
    ...
    public void initObserverable() {
        if (Observers == null) {
            Observers = new ArrayList<TalendObserver>();
        }
